...
Examples:
  klack.sh feat IN-2262                    # autonom (default)
  klack.sh feat IN-2262+review             # review nach jedem Step
  klack.sh feat IN-2262 fix IN-2200+review # mixed: IN-2262 autonom, IN-2200 mit review
